...
// ── Storage Keys ──
const LS_KEY_HOURLY = 'gmss_burn_hourly';
const LS_KEY_DAILY = 'gmss_burn_daily';
const LS_KEY_ANOMALIES = 'gmss_burn_anomalies';
const LS_KEY_CURRENT = 'gmss_burn_current';
