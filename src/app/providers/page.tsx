...
function ProvidersContent() {
    ...
    return (
        <div className="page-container">
            <div className={styles.topBar} style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
                ...
                <h1 className="page-title" style={{ margin: 0 }}>Email Providers</h1>
            </div>
            ...
            {showAdd && (
                ...
                >
                    ...
                    <button className="btn-primary" onClick={handleSave} disabled={saving || !formName || !formServiceId || !formPublicKey} style={{ width: '100%', marginTop: 16 }}>
                        <Save size={16} /> {saving ? 'Saving...' : 'Add Provider'}
                    </button>
                </motion.div>
            )}
            ...
            {/* Provider List */}
            {loading ? (
                <div style={{ marginTop: 16 }}><GlobalLoader variant="inline" /></div>
            ) : providers.length === 0 ? (
