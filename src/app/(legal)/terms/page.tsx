    ...
    return (
        <SSRShell title="Terms of Service">
            <div className="animate-fade-in">
                ...
                <P>By accessing or using the GPMAS (Gaurav&apos;s Personal Mail Automation System) platform (&quot;Service&quot;), you agree to be bound by these Terms. If you disagree with any part of the terms, you may not access the Service.</P>

                <H2>2. Use License</H2>
                <P>This is a private, proprietary system. Permission is granted to temporarily access the materials (information or software) on GPMAS for personal, non-commercial transitory viewing only.</P>
                ...
                <ul style={{ paddingLeft: '24px', color: 'var(--text-secondary)', lineHeight: 1.6, listStyle: 'disc' }}>
                    ...
                    <li style={{ marginBottom: '8px' }}>Attempt to decompile or reverse engineer any software contained on GPMAS;</li>
                ...
                <H2>3. Disclaimer</H2>
                <P>The materials on GPMAS are provided on an &apos;as is&apos; basis. GPMAS makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.</P>

                <H2>4. Limitations</H2>
                <P>In no event shall GPMAS or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on GPMAS, even if GPMAS or a GPMAS authorized representative has been notified orally or in writing of the possibility of such damage.</P>
            </div>
        </SSRShell>
    );
}
