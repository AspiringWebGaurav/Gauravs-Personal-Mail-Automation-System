...
export interface MailAuditLog {
    ...
    action: 'CREATE' | 'DELETE' | 'RETRY' | 'PROCESS_START' | 'SEND_SUCCESS' | 'SEND_FAILURE' | 'HALT_BLOCK' | 'CLAIM' | 'SYSTEM_HALT_TOGGLE' | 'INVITE';
    status: 'PENDING' | 'PROCESSING' | 'SENT' | 'FAILED' | 'HALTED' | 'DELETED' | 'RETRY_INITIATED';
