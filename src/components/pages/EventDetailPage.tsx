...
import type { GMSSEvent, Participant, EmailTemplate, EmailTheme, TokenInvite } from '@/types';
...
export default function EventDetailPage({ eventId }: EventDetailPageProps) {
    ...
    const [event, setEvent] = useState<GMSSEvent | null>(null);
    ...
    const handleInvite = async () => {
        if (!user || !event || !inviteEmail || !firebaseUser) return;
        ...
        try {
            ...
            showToast(`Sending email to ${capturedEmail}...`, 'info');
