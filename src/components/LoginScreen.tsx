                        ...
                        {!isUnauthorized ? (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span>{isLoading ? 'Authenticating...' : 'Enter Gaurav\'s Dashboard'}</span>
                                </motion.button>
                            </motion.div>
                        ) : (
                            <motion.div
                            ...
                            >
                                <div style={{
                                    ...
                                    marginBottom: '1rem', boxShadow: '0 0 20px rgba(239, 68, 68, 0.2)'
                                }}>
                                    <ShieldAlert size={24} />
                                </div>
                                ...
                                <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', textAlign: 'center', marginBottom: '1.25rem', lineHeight: 1.5 }}>
                                    This is a private automation system.<br />Only recognized administrators are permitted.
                                </p>
                                <button
